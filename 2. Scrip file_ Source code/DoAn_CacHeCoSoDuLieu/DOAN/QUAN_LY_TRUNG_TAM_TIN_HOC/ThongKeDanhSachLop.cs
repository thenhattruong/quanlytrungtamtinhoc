...
{
    public partial class ThongKeDanhSachLop : Form
    {
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string query = $"SELECT * FROM HOCVIEN WHERE MaLop = '{selectedMaLop}'";
                DataTable result = sqlInstance.ExecuteQuery(query);

                // Đổ dữ liệu vào dataview
                dgvThongKeDanhSachLop.DataSource = result;
            }
            catch (Exception )
            {
        ...
        private void dgvThongKeDanhSachLop_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void btnInDanhSach_Click(object sender, EventArgs e)
        {
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                ToExcel(dgvThongKeDanhSachLop, saveFileDialog1.FileName);
            }
        }
    }
}
